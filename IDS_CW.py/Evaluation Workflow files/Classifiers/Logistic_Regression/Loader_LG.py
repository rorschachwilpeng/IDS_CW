...
fpr_test_LG,tpr_test_LG,threshold_test_LG = roc_curve(y_test_2018,predictions_test[:,1])
roc_auc_test_LG = auc(fpr_test_LG,tpr_test_LG)
print('The Testing Set AUC: ',roc_auc_test_LG)
# fpr,tpr,threshold = roc_curve(y_test,predictions)
# roc_auc = auc(y_test, predictions)
plt.plot(fpr_test_LG, tpr_test_LG, label='ROC curve (area = %0.3f)' % roc_auc_test_LG)
